...
public class Exercise06_RaceDay {
     ...
     * numbering system.
     * 
     * Given a participant's age (int), their registration order (int), and
     ...
     * register early and their registration order is > 1000, return -1 to indicate
