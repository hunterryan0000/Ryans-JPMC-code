...
INSERT INTO animal (name, sci_name) VALUES ('Indiana Bat', 'Myotis sodalis');
INSERT INTO park_animal (park_id, animal_id, est_population)	
	SELECT 3, a.animal_id, 200
	FROM animal a WHERE name = 'Indiana Bat'; 
...
UPDATE park_animal
SET est_population = 14
	WHERE park_id = (SELECT park_id FROM park WHERE name = 'Arches')
	AND animal_id = (SELECT animal_id FROM animal WHERE name = 'Bobcat'); 
